...
<header class="header">
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<!-- <li class="has-submenu">
								...
								<ul class="submenu">
									<li><a href="admin/blank-page.php">Admin</a></li>
									<li><a href="scheduler-dashboard.php">Scheduler</a></li>
									<li><a href="patient-dashboard.php">User</a></li>
								</ul>
							</li> -->
						</ul>		 
					</div>		 
					<ul class="nav header-navbar-rht">
						<!-- <li class="nav-item">
							<a class="nav-link header-login" href="patient-dashboard.php">Profile</a>
						</li> -->
					</ul>
				</nav>
			</header>