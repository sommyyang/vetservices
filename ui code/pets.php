								...
								<div class="card-body">
									...
									<form action = >
										...
										<div class="submit-section">
											<button type="submit" class="btn btn-primary submit-btn" formaction="add-a-pet.php">Add a New Pet</button>
											<button type="submit" class="btn btn-primary submit-btn" formaction="edit-a-pet.php">Edit a pet</button>
											<button type="submit" class="btn btn-primary submit-btn" formaction="delete-a-pet.php">Remove a pet</button>
										</div>
									</form>
