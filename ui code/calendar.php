						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="card">
								<div class="card-body pt-0">
									...
									<nav class="user-tabs mb-4">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
											<li class="nav-item">
												<a class="nav-link active" href="#pat_appointments" data-toggle="tab">Appointment History</a>
											</li>
								...
								<tr>
									...
									<th>Schedulers First Name</th>
									<th>Schedulers Last Name</th>
									<th>Status</th>
									<th></th>
								</tr>
							</thead>
							<tbody>
									...
									if (isset($_SESSION['sess_id'])){
										...
										if (!$count == 1)
										{
											...
											$pid = $row['pet_id'];
											$sql = "SELECT * FROM ((appointment AS a JOIN pets AS p ON p.pet_id = a.pet_id) JOIN scheduler AS s ON a.sched_id = s.sched_id) 
											WHERE a.status = 'Approved' OR a.status = 'Denied'";
												...
												echo '
														...
														<div class="col-12 col-md-10">
															...
															<td><input type="text" class="form-control" name="sfname" value="'.$row['sched_fname'].'"readonly></td>
															<td><input type="text" class="form-control" name="slname" value="'.$row['sched_lname'].'"readonly></td>
