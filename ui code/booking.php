						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="card">
								<div class="card-body">
									...
									<form action="book_vet.php" method="POST">
										<div class="row form-row">
                                            ...
                                            <div class="col-12 col-md-6">
												...
												<input type="date" id="date" name="date" min="2020-5-01" max="2020-12-31" required>
											...
											<div class="col-12 col-md-6">
														<div class="form-group">
															<input type="text" class="form-control" name="pid" placeholder="Enter Pet ID" required>
														</div>
													</div>
									...
									echo '
													...
													<input type="text" class="form-control" value="'.$row['pet_id'].'"readonly>
													<input type="text" class="form-control" value="'.$row['pet_name'].'"readonly>
									...
									<br>
										<div class="submit-section">
											<button type="submit" name="submit" class="btn btn-primary submit-btn" name="submit">Book</button>
                                        </div>
