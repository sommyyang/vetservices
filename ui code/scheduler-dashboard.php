				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							...
							<tbody>
									...
									if (isset($_SESSION['sess_id'])){
										...
										if (!$count == 1)
										{
											...
											$pid = $row['pet_id'];
											$sql = "SELECT * FROM ((appointment AS a JOIN pets AS p ON p.pet_id = a.pet_id) JOIN clients AS c ON a.id = c.id) WHERE a.status = 'Pending'";
												...
												echo '
															...
															<tr>
															<td><input type="text" class="form-control" name="aid" value="'.$row['app_id'].'"readonly></td>
															...
															<td><input type="text" class="form-control" name="pname" value="'.$row['pet_name'].'"readonly></td>
															
															<td><input type="text" class="form-control" name="fname" value="'.$row['client_fname'].'"readonly></td>
															<td><input type="text" class="form-control" name="lname" value="'.$row['client_lname'].'"readonly></td>
															<td><input type="text" class="form-control" name="stat" value="'.$row['status'].'"readonly></td>
															<td><input type="hidden" class="form-control" name="cid" value="'.$row['id'].'"readonly></td>
															<td><input type="hidden" class="form-control" name="pid" value="'.$row['pet_id'].'"readonly></td>
														...
														echo "There are no appointments pending at this time.";
														echo "<br>";
													}
										}
							...
							<br>
							<input type="text" class="form-control" name="aid" Placeholder="Enter Appointment # for Approval/Denial." required>
							<br>
