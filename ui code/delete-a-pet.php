						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="card">
								<div class="card-body">
                                    ...
                                    <form action="delete-pet.php" method="POST">
                                    <div class="row form-row">
											...
											<div class="col-12 col-md-6">
														...
														<?php 
															...
															?>
															<br>
															<input type="text" class="form-control" name="pid" Pattern=[0-9]{1,4} title="Please enter the ID number of the pet you want to remove." Placeholder = "Enter Pet ID of pet."Required>
															</div>
													</div>

										</div>
										<div class="submit-section">
										<button type="submit" class="btn btn-primary submit-btn" name="submit">Remove</button>
