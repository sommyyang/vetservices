...
<head>
	...
	<body>
		...
		<div class="main-wrapper">
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<h2 class="breadcrumb-title">Our Veterinarian Team</h2>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- Page Content 
				Note: # will need to be changed back once profiles are corrected.-->
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-5 col-lg-4 col-xl-3 theiaStickySidebar">
							<div class="profile-sidebar">
                                    <h2>Our veterinarian's carry many years of experience under their belts. All are pet owners and lovers alike.</h2>
                                    <br>
                                    <h3>You cannot find any other doctors that are as passionate about their work in keeping your pet safe, health and happy like these folks here!</h3>
                                    <br>
                                    <h4>View one or all of our veterinarian's profiles to get a better understanding of their professions and experiences. </h4>
							</div>
                        </div>
