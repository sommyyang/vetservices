        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<!-- /Page Header -->
					<form action = "admin-added.php" Method=POST>
					<div class="row">
						<div class="col-sm-2">
                            <!-- <H3>Clients</h3> -->
                            <input type="text" class="form-control" name="aemail" Placeholder="Enter Email" required>
                            <input type="text" class="form-control" name="apwd" Placeholder="Enter password"required>
                            <input type="text" class="form-control" name="afname" Placeholder="Enter First Name"required>
                            <input type="text" class="form-control" name="alname" Placeholder="Enter Last Name"required>
