        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<!-- /Page Header -->
					<form action = "sched-removed.php" Method=POST>
					<div class="row">
						<div class="col-sm-2">
                            <!-- <H3>Clients</h3> -->
							<?php
                        
                        $sql = "SELECT * FROM scheduler ORDER BY sched_id ASC";
                        ...
                        echo
                            ...
                            while($row = mysqli_fetch_array($result)) 
                            {
                                echo '<tr>
                                <td>'.$row["sched_id"].'</td>
                                <td>'.$row["sched_fname"].' </td>
                                <td>'.$row["sched_lname"].'</td>   
                                <td>'.$row["sched_email"].'</td>            
                            </tr>';
                            }
                            "</table>";
                        ...
                        ?>
                            <input type="text" class="form-control" name="sid" Placeholder="Enter Scheduler ID" required>
                        
						<div class="submit-section">
                        <input type="submit" class="btn btn-danger btn-sm" name="disable" value="Disable">
						</div>
						</div>			
					</div>
