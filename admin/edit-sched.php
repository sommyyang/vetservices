            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Schedulers</h3>
								<ul class="breadcrumb">
					...
					<!-- /Page Header -->
					<form action = "edited-sched.php" Method=POST>
					<div class="row">
						<div class="col-sm-2">
                            <!-- <H3>Clients</h3> -->
                            <input type="text" class="form-control" name="semail" Placeholder="Enter Email" required>
                            <input type="text" class="form-control" name="spwd" Placeholder="Enter password"required>
                            <input type="text" class="form-control" name="sfname" Placeholder="Enter First Name"required>
                            <input type="text" class="form-control" name="slname" Placeholder="Enter Last Name"required>
  
                        
						<div class="submit-section">
                        <input type="submit" class="btn btn-success btn-sm" name="edit" value="Add">
						</div>
						</div>			
					</div>
